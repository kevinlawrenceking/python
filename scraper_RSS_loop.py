...
SCRAPER_SCRIPT = r"u:\docketwatch\python\docketwatch_rss_trigger.py"

SLEEP_SECONDS = 60  # 10 minutes; change as needed
...
def main():
    ...
    while True:
        try:
            code = run_scraper()
            print(f"Scraper RSS run finished with exit code {code}")
            print(f"Sleeping {SLEEP_SECONDS // 60} minute before next run...")
